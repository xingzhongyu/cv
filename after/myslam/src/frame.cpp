    ...
    void Frame::getPoints(testPoint &p){
        ...
        for(int y=0;y<color_.rows;y++){
            for(int x=0;x<color_.cols;x++){
                ...
                // points.push_back(color_.data[y*color_.step+x*color_.channels()]);
                // points.push_back(color_.data[y*color_.step+x*color_.channels()+1]);
                // points.push_back(color_.data[y*color_.step+x*color_.channels()+2]);
